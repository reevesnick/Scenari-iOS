...
class SettingsTableViewController: UITableViewController {
    ...
    @IBAction func termsButton(_:AnyObject){
        let webBroswer = KINWebBrowserViewController()
        self.navigationController?.pushViewController(webBroswer, animated: true)
        webBroswer.loadURLString("http://www.scenariapp.com/terms")  // USA Voting How to Page
    }

    @IBAction func backButton(_:AnyObject){
        let settingsStoryboard = UIStoryboard(name: "Main", bundle: nil)
        let initialSettingsVC = settingsStoryboard.instantiateInitialViewController()
        initialSettingsVC!.modalTransitionStyle = .CoverVertical
